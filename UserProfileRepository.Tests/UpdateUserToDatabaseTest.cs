...
namespace UserProfileRepository.Tests
{
    public class UpdateUserToDatabaseTest
    {
        ...
        [Fact]
        public void UpdateUserToDatabase_Should_Update_User_To_Database_If_User_Does_Exists_In_Database()
        {
            //Arrange
            ...
            //Act
            var res = _userRepository.UpdateUserToDatabase(userToUpdate);

            //Assert
            mockUserDbSet.Verify(m => m.Update(It.IsAny<User>()), Times.Once);
        ...
        public void Should_Fail_If_Context_Returns_Null()
        {
            ...
            var expected = _userRepository.AddNewUserToDatabase(userToUpdate);
