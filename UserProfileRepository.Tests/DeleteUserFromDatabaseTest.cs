...
namespace UserProfileRepository.Tests
{
    public class DeleteUserFromDatabaseTest
    {
        ...
        [Fact]
        public void DeleteUserFromDatabase_Should_Remove_User_To_Database_If_User_Exists_In_Database()
        {
            //Arrange
